...
// import { Shield, CheckCircle, XCircle, Clock, FileText, Camera, Satellite, TrendingUp, AlertTriangle, TreePine, MapPin, Calendar, User, Mail, Brain, BarChart3 } from 'lucide-react';
